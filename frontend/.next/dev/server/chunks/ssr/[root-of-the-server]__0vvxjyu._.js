...
const REWARDS = [
    {
        ...
        snapshot: "Snapshot: 19 Jul 2026, 19:00 GMT (kickoff of the World Cup Final)"
    },
    {
    ...
    },
    {
        ...
        snapshot: "Snapshot: 28 Jun 2026, ~04:00 GMT (completion of the group stage)"
    },
    {
        title: "Full Collection",
        amount: "50 AXS",
        description: "Shared between wallets holding all 48 country NFTs. Respect !       ",
        snapshot: "Snapshot: 20 Jul 2026, 19:00 GMT (24 hours after the World Cup Final begins)"
    }
];
function shortAddress(address) {
    return `${address.slice(0, 6)}...${address.slice(-4)}`;
}
async function getLogsChunked(provider, filter, fromBlock, toBlock, chunkSize = 200) {
    const logs = [];
    for(let start = fromBlock; start <= toBlock; start += chunkSize){
        ...
        try {
            ...
            console.error(`Failed fetching logs ${start} -> ${end}`, err);
            throw err;
        }
    }
    return logs;
...
function LeaderboardPage() {
    ...
    async function loadLeaderboard() {
       ...
       */ const fromBlock = Math.max(0, currentBlock - 250_000);
            const transferLogs = await getLogsChunked(provider, {
            ...
            const mintLogs = await getLogsChunked(provider, {
                address: __TURBOPACK__imported__module__$5b$project$5d2f$ronin$2d$worldcup$2d$axie$2f$frontend$2f$app$2f$lib$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COLLECTION_ADDRESS"],
                topics: [
                    TRANSFER_SINGLE_TOPIC,
                    null,
