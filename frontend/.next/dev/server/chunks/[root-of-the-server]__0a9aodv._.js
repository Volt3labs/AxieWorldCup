...
"[project]/ronin-worldcup-axie/frontend/app/lib/indexer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$ronin$2d$worldcup$2d$axie$2f$frontend$2f$node_modules$2f40$neondatabase$2f$serverless$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/ronin-worldcup-axie/frontend/node_modules/@neondatabase/serverless/index.mjs [app-route] (ecmascript)");
...
const sql = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ronin$2d$worldcup$2d$axie$2f$frontend$2f$node_modules$2f40$neondatabase$2f$serverless$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["neon"])(process.env.DATABASE_URL);
function sleep(ms) {
...
async function loadState() {
  ...
  `;
    return rows[0]?.value ?? emptyState();
}
...
async function updateIndex(maxBlocks = MAX_BLOCKS_PER_CALL) {
    const collection = ("TURBOPACK compile-time value", "0x9f0ba160473ab48027cb1b6c0fc166cc66f9f9fb");
    const rpc = process.env.RONIN_RPC_URL;
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    if (!rpc) throw new Error("Missing RONIN_RPC_URL");
    if (!process.env.DATABASE_URL) throw new Error("Missing DATABASE_URL");
    const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$ronin$2d$worldcup$2d$axie$2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].JsonRpcProvider(rpc);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$ronin$2d$worldcup$2d$axie$2f$frontend$2f$app$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/ronin-worldcup-axie/frontend/app/lib/indexer.ts [app-route] (ecmascript)");
const dynamic = "force-dynamic";
;
async function GET() {
    try {
        const { state, chainCurrentBlock, isFullySynced } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$ronin$2d$worldcup$2d$axie$2f$frontend$2f$app$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateIndex"])();
        return Response.json({
            lastIndexedBlock: state.lastIndexedBlock,
            chainCurrentBlock,
            isFullySynced,
            collectors: (0, __TURBOPACK__imported__module__$5b$project$5d2f$ronin$2d$worldcup$2d$axie$2f$frontend$2f$app$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildCollectors"])(state),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0a9aodv._.js.map